...
#define POST_RX_WAIT 1000         // RX "settle" delay
...
//Moteino #1 918MHz
//#define FREQ_CORR -450
//Moteino #1 868MHz
//#define FREQ_CORR 100
//Moteino #2 918Mhz
//#define FREQ_CORR -340
//Moteino #2 868Mhz
//#define FREQ_CORR 75
...
#define DAVIS_INTV_CORR 1  // Used in the formula to calculate the station transmission interval - (41 + id) / 16
                           ...
                           // I used a value of 0.9970 to bring measured values in line with calculated numbers
//Moteino #1
//#define DAVIS_INTV_CORR 0.99820  // Used in the formula to calculate the station transmission interval - (41 + id) / 16
//Moteino #2
//#define DAVIS_INTV_CORR 0.99750  // Used in the formula to calculate the station transmission interval - (41 + id) / 16
...
class DavisRFM69 {
  public:
    ...
    static volatile uint32_t txPeriod;
...
// M Crossley update - 09 May 2020
    {0xD9,0x03,0x75},  // 868054000 -> 868054016
    {0xD9,0x12,0xD1},  // 868294000 -> 868294006
    {0xD9,0x22,0x2D},  // 868534000 -> 868533996
    {0xD9,0x0B,0x23},  // 868174000 -> 868174011
    {0xD9,0x1A,0x7F}   // 868414000 -> 868414001
};
