...
//Moteino #1
#define FREQ_CORR -450      // Frequency correction factor for RFM69 = (Required correction Hz) / 61
//Moteino #2
//#define FREQ_CORR -340      // Frequency correction factor for RFM69 = (Required correction Hz) / 61
...
//Moteino #1
#define DAVIS_INTV_CORR 0.99811  // Used in the formula to calculate the station transmission interval - (41 + id) / 16
//Moteino #2
//#define DAVIS_INTV_CORR 0.99710  // Used in the formula to calculate the station transmission interval - (41 + id) / 16
